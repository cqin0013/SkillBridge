// knowledge.static.ts
// Typed export of knowledge categories, plus exported category-name literals.

import type { AbilityItem, KnowledgeCategories } from '../types/ability';

/** Top-level keys for consumers that need enumerations */
export { KNOWLEDGE_CATEGORY_NAMES } from '../types/ability';

/** Strongly-typed data object reconstructed from source */
export const knowledgeCategories: KnowledgeCategories = {
  management: [
...
/** Flat list helper for consumers that need one array */
export const allKnowledgeItems: AbilityItem[] = Object.values(knowledgeCategories).flat();
